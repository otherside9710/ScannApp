...
namespace ScannerDemo
{
    class Scanner
    {
        ...
        {
           /* const string WIA_SCAN_COLOR_MODE = "1146";
            const string WIA_HORIZONTAL_SCAN_RESOLUTION_DPI = "1147";
            const string WIA_VERTICAL_SCAN_RESOLUTION_DPI = "1148";
            const string WIA_HORIZONTAL_SCAN_START_PIXEL = "1149";
            const string WIA_VERTICAL_SCAN_START_PIXEL = "1150";
            const string WIA_HORIZONTAL_SCAN_SIZE_PIXELS = "1151";
            const string WIA_VERTICAL_SCAN_SIZE_PIXELS = "1152";
            const string WIA_SCAN_BRIGHTNESS_PERCENTS = "1154";
            const string WIA_SCAN_CONTRAST_PERCENTS = "1155";
